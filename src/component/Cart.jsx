            ...
            <div>
              ...
              {!cartArr.length ? (
                ...
                <div className="flex justify-end space-x-4">
                  ...
                  <button
                    type="button"
                    className="rounded-md border border-black px-3 py-2 text-sm font-semibold text-black shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black" onClick={() => navigate('/checkout')}
                  >
                    Checkout
                  </button>
                </div>
